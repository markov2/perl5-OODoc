...
They are completed with the defaults set by OODoc::Format::Pod subroutine createManual option format_options.
...
OODoc::Format::Pod subroutine createManual option format_options or L<OODoc::createManual(format_options)|OODoc/"Formatter">
